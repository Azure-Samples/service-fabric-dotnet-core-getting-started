...
dotnet restore -s https://api.nuget.org/v3/index.json 
dotnet build 
dotnet publish -c Release --runtime win-x64 -o ..\..\VisualObjectsApplicationCSharp\VisualObjects.ActorServicePkg\Code
popd

pushd src\VisualObjects.WebService\
dotnet restore -s https://api.nuget.org/v3/index.json 
dotnet build
dotnet publish -c Release --runtime win-x64 -o ..\..\VisualObjectsApplicationCSharp\VisualObjects.WebServicePkg\Code
popd
