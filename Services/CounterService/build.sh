...
dotnet restore -s https://api.nuget.org/v3/index.json
dotnet build 
dotnet publish -c Release --runtime linux-x64 -o ../../../CounterServiceApplication/CounterServicePkg/Code
cd -
...
dotnet restore -s https://api.nuget.org/v3/index.json
dotnet build 
dotnet publish -c Release --runtime linux-x64 -o ../../../../CounterServiceApplication/CounterServiceWebServicePkg/Code/
cd -
