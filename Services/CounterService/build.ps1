...
dotnet restore -s https://api.nuget.org/v3/index.json
dotnet build 
dotnet publish -c Release --runtime win-x64 -o ..\..\..\CounterServiceApplication\CounterServicePkg\Code
popd
...
dotnet restore -s https://api.nuget.org/v3/index.json
dotnet build 
dotnet publish -c Release --runtime win-x64 -o ..\..\..\..\CounterServiceApplication\CounterServiceWebServicePkg\Code\
popd