    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            try
            {
                ...
                ServiceEventListener listener = new ServiceEventListener("CounterServiceWebService");
                ...
                ServiceRuntime.RegisterServiceAsync("CounterServiceWebServiceType", context => new CounterServiceWebService (context)).GetAwaiter().GetResult();
