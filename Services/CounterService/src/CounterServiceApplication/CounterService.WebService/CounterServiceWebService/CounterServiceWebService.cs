...
namespace CounterServiceApp
{
    ...
    internal sealed class CounterServiceWebService : StatelessService
    {
        public CounterServiceWebService(StatelessServiceContext context)
            : base(context)
        { }
